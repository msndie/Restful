...
CREATE TABLE IF NOT EXISTS ex02.lessons (
    ...
    CONSTRAINT users FOREIGN KEY ( teacher_id ) REFERENCES ex02.users ( id ) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS ex02.course_teachers (
    ...
    CONSTRAINT users FOREIGN KEY ( teacher_id ) REFERENCES ex02.users ( id ) ON DELETE CASCADE,
    CONSTRAINT courses FOREIGN KEY ( course_id ) REFERENCES ex02.courses ( id ) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS ex02.course_students (
    ...
    CONSTRAINT users FOREIGN KEY ( student_id ) REFERENCES ex02.users ( id ) ON DELETE CASCADE,
    CONSTRAINT courses FOREIGN KEY ( course_id ) REFERENCES ex02.courses ( id ) ON DELETE CASCADE
);
