...
INSERT INTO ex01.users (id, first_name, last_name, role, login, password)
VALUES
...
INSERT INTO ex01.courses (id, start_date, end_date, name, description)
VALUES
...
INSERT INTO ex01.lessons (id, teacher_id, course_id, start_time, end_time, day_of_week)
VALUES
...
INSERT INTO ex01.course_students (student_id, course_id)
VALUES
       (4, 1),
       (5, 2),
       (6, 3)
...
INSERT INTO ex01.course_teachers (teacher_id, course_id)
VALUES
       (1, 1),
       (2, 2),
       (3, 3)
